...
let container = document.querySelector('.nestedFunctions')
container.innerHTML = `Результатом виклику outerFunction(arg1)(arg2)(arg3) має бути добуток arg1 * arg2 * arg3: ${result}`
/*
